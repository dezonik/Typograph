var typographme = function (text) {
   ...
   text = text.replace(/(^8|[^\d]8)( |\xA0)?( |\xA0|−|–|—)?(\()?( |\xA0)?([0-9]{1,4})( |\xA0)?(\))?( |\xA0|−|–|—)?( |\xA0)?([0-9]{1,3})( |\xA0)?( |\xA0|−|–|—)?( |\xA0)?([0-9]{2})( |\xA0)?( |\xA0|−|–|—)?( |\xA0)?([0-9]{2})/g,"$1\xA0$4$6$8\xA0$11–$15–$19");
   ...
   text = text.replace(/([^\d])(\s?)(\.|\,|\:|\;|\!|\?)([^\.|\,|\:|\;|\!|\?|»|”|’])/g, "$1$3 $4");        // Привет ,как дела
   text = text.replace(/(\S)(\s?)(\.|\,|\:|\;|\!|\?)([^\.|\,|\:|\;|\!|\?|»|”|’|\d])/g, "$1$3 $4");        // Привет ,как дела
