var typographme = function (text) {
    ...
    text = text.replace(/<-/g, "←");
    text = text.replace(/->/g, "→");
    text = text.replace(/(\S)( |\xA0)?(\+-)|(\+\/-)\s?(\d|\(|\))/g, "$1\xA0±\xA0$5");
    text = text.replace(/(\S)( |\xA0)?\!\=\s?(\d|\(|\))/g, "$1\xA0≠\xA0$3");
    text = text.replace(/(\S)( |\xA0)?(\+|\-|\=|\*|\/|≈|×)\s?(\d|\(|\))/g, "$1\xA0$3\xA0$4");
    text = text.replace(/(\S)( |\xA0)?\-\s?(\d|\(|\))/g, "$1\xA0−\xA0$3");
